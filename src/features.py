...
def extract_features(data_path="data/processed/cleaned_news.csv", max_features=5000):
    ...
    """
    print("[Features] Loading preprocessed text data...")
    ...
    print(f"[Features] Extracting top {max_features} TF-IDF features...")
    ...
    print("[Features] Splitting dataset into Train (80%) and Test (20%) sets...")
    # Stratify ensure classes are evenly distributed between train and test splits
    X_train, X_test, y_train, y_test = train_test_split(
        X_vectorized, y, test_size=0.2, random_state=42, stratify=y
    )
    
    print(f"[Features] Feature extraction complete.")
